            ...
            Dictionary<string, int> indexCounts)
        {
...

            {
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(MHSetting.MagicResetCemetery)),
                    "**ทำให้สุสานที่เต็มว่างลง** เพื่อไม่ให้ถูกปิดกั้นด้วยไอคอน FULL\n" +
                    "Magic Clean จะนำศพส่วนใหญ่ออกก่อนฝัง แต่ตัวเลือกนี้ยังคงล้างสุสานที่ **เต็มอยู่แล้ว**\n" +
                    "[ ✓ ] เปิดเป็นค่าเริ่มต้น\n" +
                    "หากไม่มีสุสานที่เต็มและไม่กังวลเรื่องนี้ รวมทั้งเปิด Magic Clean ไว้เสมอ\n" +
                    " ก็สามารถปิดตัวเลือกนี้ได้ เพราะไม่จำเป็นต้องใช้"
                },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(MHSetting.AutoResetCemetery)),
                    "**ทำให้สุสานว่างลง** เมื่อเต็ม เพื่อไม่ให้ถูกปิดกั้นด้วยไอคอน FULL เหนืออาคาร\n" +
