            ...
            Dictionary<string, int> indexCounts)
        {
...

            {
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(MHSetting.MagicResetCemetery)),
                    ...
                    "<[ ] ค่าเริ่มต้น ปิด>.\n" +
                    "เปิดตัวเลือกนี้เฉพาะเมื่อมีสุสานที่เต็มอยู่แล้วเท่านั้น\n" +
                    "ตัวเลือกนี้ช่วยทำความสะอาดเมืองเก่า แต่ไม่จำเป็นต้องเปิดค้างไว้หากเปิดการทำความสะอาดแบบเวทมนตร์อยู่\n" +
                    "โดยปกติสุสานใหม่จะไม่เต็มหากเปิดการทำความสะอาดแบบเวทมนตร์"
                },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(MHSetting.HearseWarningMinutes)), "หน่วงไอคอนการเสียชีวิต" },
                { m_Setting.GetOptionDescLocaleID(nameof(MHSetting.HearseWarningMinutes)),
                    "นี่คือจำนวนนาทีทั้งหมดที่รถศพมีเพื่อไปถึงอาคารก่อนที่ไอคอนปัญหา **รอรถศพ** จะปรากฏ\n" +
                    ...
                    "- ไอคอนที่มองเห็นอยู่แล้วจะไม่ถูกซ่อนเมื่อเพิ่มเวลานี้ครั้งแรก โปรดให้เวลาระบบปรับตัวระหว่างที่งานเดิมกำลังเสร็จสิ้น\n" +
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(MHSetting.CemeteryTurnoverScalar)),
                    ...
                    "ให้เปิด **[รีเซ็ตสุสานที่เต็ม]** แทน\n" +
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(MHSetting.ResetGameDefaults)), "ตั้งแถบเลื่อนเปอร์เซ็นต์เป็น **100%** และเวลาหน่วงไอคอนการเสียชีวิตเป็น **3 นาที**" },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(MHSetting.StatusSummary1)),
                    ...
                    " - หากมีจำนวนเกินเวลามาก ให้ลองเพิ่มเวลาหน่วงไอคอนการเสียชีวิต"
                },
