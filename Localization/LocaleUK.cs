            ...
            Dictionary<string, int> indexCounts)
        {
...

            {
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(MHSetting.MagicResetCemetery)),
                    ...
                    "<[ ] Типово ВИМКНЕНО>.\n" +
                    "Увімкніть цей параметр лише якщо вже є заповнені кладовища.\n" +
                    "Цей параметр допомагає під час очищення старих міст, але його не потрібно залишати увімкненим, якщо Магічне очищення активне.\n" +
                    "Нове кладовище зазвичай ніколи не заповниться, якщо Магічне очищення УВІМКНЕНО."
                },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(MHSetting.HearseWarningMinutes)), "Затримка піктограми смерті" },
                { m_Setting.GetOptionDescLocaleID(nameof(MHSetting.HearseWarningMinutes)),
                    "Це загальна кількість хвилин, за яку катафалк має дістатися будівлі, перш ніж з’являться піктограми проблеми **очікування катафалка**.\n" +
                    ...
                    "- Уже видимі піктограми не приховуються, коли цей час уперше збільшується; дайте системі трохи часу стабілізуватися, поки завершуються попередні виїзди.\n" +
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(MHSetting.CemeteryTurnoverScalar)),
                    ...
                    "увімкніть натомість **[Скинути заповнене кладовище]**.\n" +
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(MHSetting.ResetGameDefaults)), "Встановлює відсоткові повзунки на **100%**, а затримку піктограми смерті — на **3 хвилини**." },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(MHSetting.StatusSummary1)),
                    ...
                    " - Якщо прострочених випадків багато, збільште Затримку піктограми смерті."
                },
