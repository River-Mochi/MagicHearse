            ...
            Dictionary<string, int> indexCounts)
        {
...

            {
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(MHSetting.MagicResetCemetery)),
                    ...
                    "Магічне очищення видаляє більшість тіл до поховання — ця опція також очищає кладовища, які **вже заповнені**.\n" +
                    "[ ✓ ] УВІМКНЕНО за замовчуванням.\n" +
                    "Якщо заповнених кладовищ немає, це не викликає занепокоєння, а магічне очищення завжди ввімкнене,\n" +
                    " цю опцію можна вимкнути, оскільки вона не потрібна."
                },
