    ...
    public sealed class LocaleZH_HANS : IDictionarySource
    {
            ...
            Dictionary<string, int> indexCounts)
        {
...

            {
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(MHSetting.ResetGameDefaults)), "将百分比滑块设为 **100%**，并将死亡图标延迟设为 **3 分钟**。" },
